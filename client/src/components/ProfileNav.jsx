...
export default function ProfileNav(props) {
    ...
    return (
        <div className='flex flex-row justify-evenly w-1/4 m-auto mt-4'>
            <NavLink activeClassName="bg-purple-100" className={`${dotStyle}`} exact to={`/users/${props.user.id}`}>
            </NavLink>
            <NavLink activeClassName="bg-purple-100" className={`${dotStyle}`} exact to={`/users/${props.user.id}/page2`}>
            </NavLink>
